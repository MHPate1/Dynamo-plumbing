// Affluent, organically-rankable areas within ~1 hour of Bolton.
// Each becomes its own prerendered page (/plumber-<slug>) with unique copy so
// it reads as a genuine local page, not a thin doorway page.

export const locations = [
  {
    slug: 'plumber-wilmslow',
    area: 'Wilmslow',
    region: 'Cheshire',
  ...
  },
  {
    ...
    area: 'Prestbury',
    region: 'Cheshire',
    neighbours: ['Macclesfield', 'Alderley Edge', 'Adlington'],
    blurb:
      "Dynomo provides Prestbury with a premium plumbing and heating service built on quality and discretion. Whether it's a new Worcester Bosch boiler, underfloor heating or an emergency repair, our engineers arrive on time and leave your home spotless.",
  },
  {
    slug: 'plumber-hale',
    area: 'Hale',
  ...
  },
  {
    ...
    area: 'Hale Barns',
    region: 'Trafford, Greater Manchester',
    neighbours: ['Hale', 'Altrincham', 'Ringway'],
    blurb:
      "Dynomo is the heating engineer of choice for Hale Barns homeowners who want the job done once, done right. We specialise in premium boiler installations, smart heating controls and meticulous central heating work.",
  },
  {
    slug: 'plumber-bowdon',
    area: 'Bowdon',
  ...
  },
  {
    ...
    area: 'Worsley',
    region: 'Salford, Greater Manchester',
    neighbours: ['Boothstown', 'Walkden', 'Ellenbrook'],
    blurb:
      "In the leafy village of Worsley, Dynomo delivers premium boiler installation, heating upgrades and emergency plumbing with the reliability and tidy finish discerning homeowners expect.",
  },
  {
    slug: 'plumber-ramsbottom',
    area: 'Ramsbottom',
  ...
  },
  {
    ...
    neighbours: ['Horwich', 'Ladybridge', 'Markland Hill'],
    blurb:
      "As a Bolton-based company, Dynomo is right on the doorstep of Lostock — offering fast, reliable boiler installation, servicing, gas safety checks and emergency plumbing to one of the town's most sought-after areas.",
  },
  {
    slug: 'plumber-heaton',
    area: 'Heaton',
